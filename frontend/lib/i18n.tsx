...
const translations = {
  en: {
    ...
    "apiError.Only dev can update line OCR rotation settings":
      "Only dev can update line OCR rotation settings.",
    "apiError.PLC simulator session is not active":
      "The PLC simulator session expired. Start the simulator again.",
    "apiError.PLC simulator input is not configured":
      "This PLC input is not configured.",
    "apiError.PLC simulator is available to dev only":
      "The PLC simulator is available to dev only.",
    ...
    "plc.disconnecting": "Disconnecting PLC...",
    ...
    "plcSimulator.title": "PLC simulator",
    "plcSimulator.open": "Open PLC simulator",
    "plcSimulator.active": "Simulated PLC connected",
    "plcSimulator.inactive": "Simulator disconnected",
    "plcSimulator.enable": "Start simulator",
    "plcSimulator.enabling": "Starting PLC simulator...",
    "plcSimulator.enabled": "PLC simulator started.",
    "plcSimulator.enableError": "Unable to start PLC simulator.",
    "plcSimulator.disable": "Stop simulator",
    "plcSimulator.disabling": "Stopping PLC simulator...",
    "plcSimulator.disabled": "PLC simulator stopped.",
    "plcSimulator.disableError": "Unable to stop PLC simulator.",
    "plcSimulator.configRequired":
      "Save a valid PLC configuration before starting the simulator.",
    "plcSimulator.plcToApp": "PLC → App",
    "plcSimulator.appToPlc": "App → PLC",
    "plcSimulator.timeline": "Signal timeline",
    "plcSimulator.clear": "Clear",
    "plcSimulator.noEvents": "No simulated signal yet.",
    "plcSimulator.signalSent": "Sent simulated signal: {signal}.",
    "plcSimulator.signalError": "Unable to send the simulated PLC signal.",
    ...
    "settings.dongilStation": "Station",
    "settings.dongilActive": "Active",
    "settings.dongilInactive": "Inactive",
    ...
    "settings.dongilDisconnect": "Disconnect server",
    "settings.dongilDisconnecting": "Disconnecting...",
    "settings.dongilDisconnected":
      "Dongil Server was disconnected. It will stay disconnected after restart until you connect it again.",
    "settings.dongilDisconnectFailed": "Could not disconnect Dongil Server.",
    ...
    "settings.dongilState.RETRYING": "Reconnecting",
    "settings.dongilState.ERROR": "Connection error",
    "settings.dongilState.UNAUTHORIZED": "Dongle authorization required",
    "historySync.startTitle": "Sync local washing history",
    "historySync.startDescription":
      "Upload and verify only new, changed or previously unverified local results in the background.",
    "historySync.alreadyRunning":
      "A history snapshot already exists. Open Processing to view or manage it.",
    "historySync.start": "Sync history",
    "historySync.starting": "Creating snapshot...",
    "historySync.startSuccess": "History synchronization started.",
    "historySync.alreadyVerified":
      "All data has already been uploaded and verified. There are no new results to process.",
    "historySync.lastSuccessfulSync": "Last synchronized at {time}",
    "historySync.startFailed": "Could not start history synchronization.",
    "historySync.startConfirmTitle": "Synchronize local history?",
    "historySync.startConfirmDescription":
      "The application keeps every local result, uploads only pending data, then automatically verifies affected days or sessions. New scans continue to be saved locally.",
    "historySync.processingTitle": "Synchronizing local history",
    "historySync.processingDescription":
      "You can continue operating the machine. Local results are retained and the synchronization checkpoint is saved after each confirmed batch.",
    "historySync.compactProgress": "{confirmed} / {total} results · {percent}%",
    "historySync.compactVerifying": "Verification: {verified} / {total} results · {percent}%",
    "historySync.batchProgress": "Synchronizing batch {current} / {total}",
    "historySync.uploadCompleted": "Data uploaded successfully",
    "historySync.completedSuccess": "Upload and verification completed successfully.",
    "historySync.resultProgress": "{confirmed} / {total} results · {percent}%",
    "historySync.reconciliationTitle": "Verifying with Dongil Server",
    "historySync.reconciliationProgress": "{verified} / {total} result IDs · {percent}%",
    "historySync.reconciliationScopes": "{completed} / {total} scopes completed",
    "historySync.reconciliationCurrentScope": "Current: {scope} · {scopeKey}",
    "historySync.reconciliationPhase.WAITING_FOR_UPLOAD": "Waiting for every result to be delivered",
    "historySync.reconciliationPhase.COUNTERS": "Comparing total, OK and NG counts",
    "historySync.reconciliationPhase.RESULT_IDS": "Verifying exact result IDs",
    "historySync.reconciliationPhase.FINALIZING": "Finalizing verification",
    "historySync.reconciliationPhase.COMPLETED": "Verification complete",
    "historySync.accepted": "Newly sent",
    "historySync.replayed": "Already on server",
    "historySync.failed": "Failed",
    "historySync.currentBatchId": "Current batch",
    "historySync.lastRetry": "Last retry",
    "historySync.checkpoint": "Last checkpoint",
    "historySync.manualReview": "Manual review required",
    "historySync.viewManualItems": "View list",
    "historySync.manualItemsDescription":
      "{count} historical records need manual handling because a stable local result ID is unavailable.",
    "historySync.manualItemsEmpty": "No manual-review records were found.",
    "historySync.manualItemsLoadFailed": "Could not load manual-review records.",
    "historySync.manualItemsSource": "Local source",
    "historySync.manualItemsReason": "Reason",
    "historySync.manualItemsCapturedAt": "Captured at",
    "historySync.continueOperation": "Continue operating",
    "historySync.pause": "Pause",
    "historySync.resume": "Resume",
    "historySync.retryFailures": "Retry failures",
    "historySync.cancel": "Cancel synchronization",
    "historySync.cancelling": "Canceling...",
    "historySync.cancelConfirmTitle": "Cancel history synchronization?",
    "historySync.cancelConfirmDescription": "The current run will stop after its active batch. Local results and results already received by Dongil Server will be kept.",
    "historySync.loadFailed": "Could not load history synchronization status.",
    "historySync.actionFailed": "Could not update history synchronization.",
    "historySync.state.PREPARING": "Preparing snapshot",
    "historySync.state.RUNNING": "Synchronizing",
    "historySync.state.PAUSED": "Paused",
    "historySync.state.BLOCKED": "Needs reconnection",
    "historySync.state.CANCELLED": "Cancelled",
    "historySync.state.COMPLETED": "Completed",
    ...
    "settings.presetFactory": "Factory 1280 x 1024",
    ...
    "operator.recognition": "Recognition",
    ...
    "camera.disconnecting": "Disconnecting camera...",
    "camera.disconnectSuccess":
      "Camera disconnected. Automatic reconnect is paused.",
    "camera.disconnectError": "Cannot disconnect the camera.",
  ...
  vi: {
    ...
    "apiError.Only dev can update line OCR rotation settings":
      "Chỉ dev mới có thể cập nhật setting xoay crop OCR cho line.",
    "apiError.PLC simulator session is not active":
      "Phiên PLC giả lập đã hết hạn. Hãy bật lại giả lập.",
    "apiError.PLC simulator input is not configured":
      "Tín hiệu PLC này chưa được cấu hình.",
    "apiError.PLC simulator is available to dev only":
      "PLC giả lập chỉ dành cho role dev.",
    "apiError.Only admin or dev can manage machine inactivity settings":
    ...
    "plc.disconnecting": "Đang ngắt kết nối PLC...",
    ...
    "plcSimulator.title": "PLC giả lập",
    "plcSimulator.open": "Mở PLC giả lập",
    "plcSimulator.active": "PLC giả lập đã kết nối",
    "plcSimulator.inactive": "PLC giả lập chưa kết nối",
    "plcSimulator.enable": "Bật giả lập",
    "plcSimulator.enabling": "Đang bật PLC giả lập...",
    "plcSimulator.enabled": "Đã bật PLC giả lập.",
    "plcSimulator.enableError": "Không thể bật PLC giả lập.",
    "plcSimulator.disable": "Tắt giả lập",
    "plcSimulator.disabling": "Đang tắt PLC giả lập...",
    "plcSimulator.disabled": "Đã tắt PLC giả lập.",
    "plcSimulator.disableError": "Không thể tắt PLC giả lập.",
    "plcSimulator.configRequired":
      "Hãy lưu cấu hình PLC hợp lệ trước khi bật giả lập.",
    "plcSimulator.plcToApp": "PLC → Ứng dụng",
    "plcSimulator.appToPlc": "Ứng dụng → PLC",
    "plcSimulator.timeline": "Dòng thời gian tín hiệu",
    "plcSimulator.clear": "Xóa",
    "plcSimulator.noEvents": "Chưa có tín hiệu giả lập.",
    "plcSimulator.signalSent": "Đã gửi tín hiệu giả lập: {signal}.",
    "plcSimulator.signalError": "Không thể gửi tín hiệu PLC giả lập.",
    ...
    "settings.dongilStation": "Trạm",
    "settings.dongilActive": "Đang hoạt động",
    "settings.dongilInactive": "Không hoạt động",
    ...
    "settings.dongilDisconnect": "Ngắt kết nối server",
    "settings.dongilDisconnecting": "Đang ngắt kết nối...",
    "settings.dongilDisconnected":
      "Đã ngắt kết nối Dongil Server. Ứng dụng sẽ không tự kết nối lại sau khi khởi động cho đến khi bạn kết nối lại.",
    "settings.dongilDisconnectFailed": "Không thể ngắt kết nối Dongil Server.",
    ...
    "settings.dongilState.RETRYING": "Đang kết nối lại",
    "settings.dongilState.ERROR": "Lỗi kết nối",
    "settings.dongilState.UNAUTHORIZED": "Cần xác thực dongle",
    "historySync.startTitle": "Đồng bộ lịch sử máy rửa",
    "historySync.startDescription":
      "Chỉ đẩy và đối chiếu nền các kết quả local mới, đã thay đổi hoặc chưa được xác minh.",
    "historySync.alreadyRunning":
      "Đã có snapshot lịch sử. Mở màn Processing để xem hoặc điều khiển.",
    "historySync.start": "Đồng bộ lịch sử",
    "historySync.starting": "Đang tạo snapshot...",
    "historySync.startSuccess": "Đã bắt đầu đồng bộ lịch sử.",
    "historySync.alreadyVerified":
      "Toàn bộ dữ liệu đã được đẩy và đối chiếu. Không có kết quả mới cần xử lý.",
    "historySync.lastSuccessfulSync": "Đồng bộ lần cuối lúc {time}",
    "historySync.startFailed": "Không thể bắt đầu đồng bộ lịch sử.",
    "historySync.startConfirmTitle": "Đồng bộ lịch sử local?",
    "historySync.startConfirmDescription":
      "Ứng dụng giữ nguyên mọi kết quả local, chỉ đẩy dữ liệu đang chờ rồi tự động đối chiếu các ngày hoặc phiên bị ảnh hưởng. Kết quả quét mới vẫn được lưu local.",
    "historySync.processingTitle": "Đang đồng bộ lịch sử local",
    "historySync.processingDescription":
      "Bạn vẫn có thể vận hành máy. Kết quả local được giữ lại và checkpoint được lưu sau mỗi batch đã xác nhận.",
    "historySync.compactProgress": "{confirmed} / {total} kết quả · {percent}%",
    "historySync.compactVerifying": "Đối chiếu: {verified} / {total} kết quả · {percent}%",
    "historySync.batchProgress": "Đang đồng bộ batch {current} / {total}",
    "historySync.uploadCompleted": "Đã đẩy dữ liệu thành công",
    "historySync.completedSuccess": "Đã đẩy và đối chiếu dữ liệu thành công.",
    "historySync.resultProgress": "{confirmed} / {total} kết quả · {percent}%",
    "historySync.reconciliationTitle": "Đối chiếu với Dongil Server",
    "historySync.reconciliationProgress": "{verified} / {total} mã kết quả · {percent}%",
    "historySync.reconciliationScopes": "Đã xong {completed} / {total} phạm vi",
    "historySync.reconciliationCurrentScope": "Đang đối chiếu: {scope} · {scopeKey}",
    "historySync.reconciliationPhase.WAITING_FOR_UPLOAD": "Chờ gửi xong toàn bộ kết quả",
    "historySync.reconciliationPhase.COUNTERS": "Đang so sánh tổng, OK và NG",
    "historySync.reconciliationPhase.RESULT_IDS": "Đang xác thực chính xác mã kết quả",
    "historySync.reconciliationPhase.FINALIZING": "Đang hoàn tất xác minh",
    "historySync.reconciliationPhase.COMPLETED": "Đã xác minh hoàn tất",
    "historySync.accepted": "Đã gửi mới",
    "historySync.replayed": "Đã có trên server",
    "historySync.failed": "Lỗi",
    "historySync.currentBatchId": "Batch hiện tại",
    "historySync.lastRetry": "Lần thử lại gần nhất",
    "historySync.checkpoint": "Checkpoint gần nhất",
    "historySync.manualReview": "Cần xử lý thủ công",
    "historySync.viewManualItems": "Xem danh sách",
    "historySync.manualItemsDescription":
      "{count} bản ghi lịch sử cần xử lý thủ công vì không có localResultId ổn định.",
    "historySync.manualItemsEmpty": "Không tìm thấy bản ghi cần xử lý thủ công.",
    "historySync.manualItemsLoadFailed": "Không thể tải danh sách cần xử lý thủ công.",
    "historySync.manualItemsSource": "Nguồn local",
    "historySync.manualItemsReason": "Lý do",
    "historySync.manualItemsCapturedAt": "Thời điểm quét",
    "historySync.continueOperation": "Tiếp tục vận hành",
    "historySync.pause": "Tạm dừng",
    "historySync.resume": "Tiếp tục",
    "historySync.retryFailures": "Thử lại lỗi",
    "historySync.cancel": "Hủy đồng bộ",
    "historySync.cancelling": "Đang hủy...",
    "historySync.cancelConfirmTitle": "Hủy đồng bộ lịch sử?",
    "historySync.cancelConfirmDescription": "Lượt đồng bộ sẽ dừng sau batch đang xử lý. Kết quả local và dữ liệu đã nhận trên Dongil Server vẫn được giữ nguyên.",
    "historySync.loadFailed": "Không thể tải trạng thái đồng bộ lịch sử.",
    "historySync.actionFailed": "Không thể cập nhật đồng bộ lịch sử.",
    "historySync.state.PREPARING": "Đang tạo snapshot",
    "historySync.state.RUNNING": "Đang đồng bộ",
    "historySync.state.PAUSED": "Đã tạm dừng",
    "historySync.state.BLOCKED": "Cần kết nối lại",
    "historySync.state.CANCELLED": "Đã hủy",
    "historySync.state.COMPLETED": "Hoàn tất",
    ...
    "settings.presetFactory": "Máy vận hành 1280 x 1024",
    "settings.presetHd": "HD 1366 x 768",
    "settings.presetFullHd": "Full HD 1920 x 1080",
    "settings.presetFourThree": "4:3 1280 x 960",
    ...
    "operator.recognition": "Nhận diện",
    ...
    "camera.disconnect": "Ngắt kết nối camera",
    "camera.disconnecting": "Đang ngắt kết nối camera...",
    "camera.disconnectSuccess":
      "Đã ngắt camera. Hệ thống sẽ không tự kết nối lại.",
    "camera.disconnectError": "Không thể ngắt kết nối camera.",
...
const translationOverrides: Record<Language, Record<string, string>> = {
  en: {
    ...
    "operator.changingProduct": "Changing product...",
  ...
  vi: {
    ...
    "operator.changingProduct": "Đang chuyển mã...",
    "operator.productChangedWaitingStart":
