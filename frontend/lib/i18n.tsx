...
const translationOverrides: Record<Language, Record<string, string>> = {
  en: {
    ...
    "settings.ocrTestSaved": "Applied line OCR crop rotation setting to {count} product(s).",
    ...
    "settings.ocrTestStorageSaveError": "Cannot save the line validation folder setting.",
    "settings.ocrTestStorageLoadError": "Cannot load the line validation folder setting.",
    ...
    "lineTest.imageCleared": "Selected image cleared. Live camera will be used.",
  ...
  vi: {
    ...
    "settings.ocrTestSaved": "Đã áp dụng setting xoay crop OCR cho line của {count} mã hàng.",
    "settings.ocrTestSaveError": "Không thể áp dụng setting xoay crop OCR cho line.",
    ...
    "lineTest.rotateBeforeTransmit": "Xoay crop 90\u00b0 theo chi\u1ec1u kim \u0111\u1ed3ng h\u1ed3 tr\u01b0\u1edbc khi OCR",
    "lineTest.savingRotateSetting": "\u0110ang l\u01b0u setting xoay...",
    "lineTest.rotateSettingSaved": "\u0110\u00e3 l\u01b0u setting xoay OCR cho line.",
    "lineTest.rotateSettingSaveError": "Kh\u00f4ng th\u1ec3 l\u01b0u setting xoay OCR cho line.",
